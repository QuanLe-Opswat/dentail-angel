...
const schema = {
    ...
    ServiceType: {
        row: 1,
        fileNo: 1,
        fileName: 'Goi dich vu',
        model: 'ServiceTypeModel',
        column: [{ prop: 'ID', type: 'Number', required: true, name: 'ID' },
            { prop: 'ServiceName', type: 'String', required: true, name: 'Tên dịch vụ' },
            { prop: 'PriceFrom', type: 'Number', required: true, name: 'Giá từ' },
            { prop: 'PriceTo', type: 'Number', required: true, name: 'Giá đến' },
    ...
    Doctor: {
        row: 1,
        fileNo: 2,
        fileName: 'Bac si nha khoa',
        model: 'DoctorModel',
        column: [{ prop: 'ID', type: 'Number', required: true, name: 'ID' },
            { prop: 'DoctorName', type: 'String', required: true, name: 'Tên bác sĩ' },
            { prop: 'Comment', type: 'String', name: 'Ghi chú' }],
        defaultData: {
            ...Default_Push,
        },
    ...
    Client: {
        ...
        model: 'ClientModel',
        column: [{ prop: 'ID', type: 'Number', required: true, name: 'ID' },
            { prop: 'ClientFullName', type: 'String', required: true, default: '0000000000', name: 'Tên khách hàng' },
            { prop: 'PhoneNumber', type: 'String', required: true, name: 'Số điện thoại' },
            {
            ...
            { prop: 'BirthDateTime', type: 'Date', name: 'Ngày sinh' },
            { prop: 'Comment', type: 'String', name: 'Ghi chú' }],
        defaultData: {
            ...Default_Push,
    ...
    Service: {
        row: 1,
        fileNo: 4,
        fileName: 'Dich vu khach hang',
        model: 'ServiceModel',
        column: [{ prop: 'ID', type: 'Number', required: true, name: 'ID' },
            { prop: 'ClientID', type: 'Number', required: true, related: 'Client', name: 'Mã ID khách hàng (Sheet3)' },
            { prop: 'DoctorId', type: 'Number', required: true, related: 'Doctor', name: 'Mã ID bác sĩ (Sheet2)' },
            {
                prop: 'ServiceTypeId',
                type: 'Number',
                required: true,
            ...
            { prop: 'ServiceDateTime', type: 'Date', required: true, name: 'Ngày sử dụng dịch vụ' },
            { prop: 'TotalFee', type: 'Number', required: true, name: 'Tổng chi phí', default: 1 },
            {
    ...
    Paid: {
        ...
        column: [{ prop: 'ID', type: 'Number', required: true, name: 'ID' },
            ...
            { prop: 'CashPaied', type: 'Number', required: true, name: 'Số tiền đã thanh toán' },
